            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <th>Nama Lengkap</th>
                            <td><input type="text" name="nama_lengkap" value="<?= htmlspecialchars($row['nama_lengkap']); ?>" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>Email</th>
                        ...
                        <tr>
                            <th>Alamat</th>
                            <td><input type="text" name="alamat" value="<?= htmlspecialchars($row['alamat']); ?>" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>NIK</th>
                            <td><input type="text" name="nik" value="<?= htmlspecialchars($row['nik']); ?>" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>NISN</th>
                            <td><input type="text" name="nisn" value="<?= htmlspecialchars($row['nisn']); ?>" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>Asal SLTA</th>
                            <td><input type="text" name="asal_slta" value="<?= htmlspecialchars($row['asal_slta']); ?>" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>Program Studi</th>
                            <td>
                                <select name="program_studi" class="form-select" required>
                                    ...
                                    <option value="Farmasi" <?= ($row['program_studi']=="Farmasi")?'selected':''; ?>>Farmasi</option>
                        ...
                        <tr>
                            ...
                            <td><input type="text" value="<?= date('d-m-Y', strtotime($row['tanggal_daftar'])); ?>" class="form-control" readonly></td>
                        </tr>
                    </tbody>
                </table>
            </div>

            <button type="submit" name="update" class="btn btn-primary"><i class="bi bi-save2 me-1"></i> Update</button>
