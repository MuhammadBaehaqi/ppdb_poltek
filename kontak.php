...
<body>
    ...
    <section class="position-relative text-white text-center" style="height: 60vh;">
        <img src="img/kontak.jpg" class="w-100 h-100 position-absolute top-0 start-0" style="object-fit: cover;"
            alt="Kontak MKM">
        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col">
                    ...
                    <p>Silakan hubungi kami melalui salah satu kontak di bawah ini atau kirim pesan melalui formulir.
                    </p>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <form action="" method="post" class="card border-0 shadow p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nomor_wa" name="nomor_wa" class="form-control"
                                placeholder="Contoh: 6281234567890" required>
                        </div>
                        <div class="mb-3">
                            <label for="pesan" class="form-label fw-semibold">Pesan</label>
                            <textarea id="pesan" name="pesan" rows="5" class="form-control"
