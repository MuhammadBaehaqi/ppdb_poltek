...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO tb_pendaftaran 
              ...
              VALUES ('$nama_lengkap', '$jenis_kelamin', '$alamat', '$nik', '$nisn', '$asal_slta', '$program_studi', '$rencana_kelas', '$bukti_pembayaran', '$status_pendaftaran', NOW())";
...
<body>
    <div class="content" style="margin-left:260px; padding:90px 20px;">
        <div class="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="file" name="bukti_pembayaran" class="form-control"
                                        accept=".jpg,.jpeg,.png,.pdf" required></td>
                            </tr>
                        </tbody>
                    </table>
                </div>

                <button type="submit" name="simpan" class="btn btn-primary"><i class="bi bi-save2 me-1"></i>
                    Simpan</button>
