            ...
            <div class="col-md-4 mb-4">
                <div class="card program-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Mempersiapkan tenaga ahli di bidang farmasi yang kompeten dan beretika, siap berkontribusi dalam pelayanan kesehatan masyarakat.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card program-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Membekali mahasiswa dengan kemampuan analisis laboratorium klinik serta pemahaman ilmu kesehatan yang mendalam.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card program-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Mengembangkan kemampuan dalam pengelolaan sistem informasi, pemrograman, dan teknologi berbasis web modern.</p>
                    </div>
                </div>
            </div>
        </div>
